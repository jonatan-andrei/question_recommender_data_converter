...
public enum RecommendationChannelType {
    ...
    RECOMMENDED_LIST(Map.ofEntries(
            ...
            entry(RELEVANCE_QUESTION_NUMBER_VIEWS, BigDecimal.valueOf(0.1)),
            entry(RELEVANCE_QUESTION_NUMBER_FOLLOWERS, BigDecimal.valueOf(1)),
            entry(RELEVANCE_QUESTION_NUMBER_UPVOTES, BigDecimal.valueOf(1)),
            entry(RELEVANCE_QUESTION_NUMBER_DOWNVOTES, BigDecimal.valueOf(-1)),
            ...
            entry(RELEVANCE_EXPLICIT_CATEGORY, BigDecimal.valueOf(200)),
            entry(RELEVANCE_QUESTIONS_ASKED_IN_CATEGORY, BigDecimal.valueOf(50)),
            entry(RELEVANCE_QUESTIONS_ANSWERED_IN_CATEGORY, BigDecimal.valueOf(300)),
            entry(RELEVANCE_QUESTIONS_COMMENTED_IN_CATEGORY, BigDecimal.valueOf(100)),
            ...
            entry(RELEVANCE_EXPLICIT_TAG, BigDecimal.valueOf(200)),
